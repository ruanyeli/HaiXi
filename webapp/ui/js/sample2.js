...
function adjustSpreadSize() {
    var height = $("#inner-content-container").height() - ($("#formulaBar:visible").length > 0 ? $("#formulabar2").height() : 0) - MARGIN_BOTTOM,
...
function processSpreadContextMenu(e) {
    ...
    if (isHideContextMenu) {
        ...
        $contextMenu.css({left: e.pageX + "px", top: e.pageY - document.body.clientHeight + "px"});
        $contextMenu.show();
