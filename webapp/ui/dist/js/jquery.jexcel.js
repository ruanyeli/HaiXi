                    ...
                    if ($(table).is('.jexcel')) {
                        ...
                        if ($(e.target).parent().parent().is('tbody')) {
                            ...
                            if ($(e.target).is('.label')) {
                            	...
                            	$(table).find("tbody td").on('mouseover', function (e) {
                                    // Cells
                                    var cells = $(table).find('tbody td');
                                    var header = $(table).find('thead td');
                                    ...
                                    for (i = px; i <= ux; i++) {
                                        for (j = py; j <= uy; j++) {
                                        	//console.log("aaa");
                                            $(table).find('#' + i + '-' + j).addClass('highlight');
                                            $(table).find('#' + px + '-' + j).addClass('highlight-left');
                                            $(table).find('#' + ux + '-' + j).addClass('highlight-right');
                                            $(table).find('#' + i + '-' + py).addClass('highlight-top');
                                            $(table).find('#' + i + '-' + uy).addClass('highlight-bottom');

                                            // Row and column headers
                                            $(table).find('#col-' + i).addClass('selected');
                                            $(table).find('#row-' + j).addClass('selected');
                                        }
                                    }
//                                    console.log("o[0]="+o[0]);
//                                    console.log("o[1]="+o[1]);
...
//                            		$(this).addClass("highlight highlight-left highlight-right highlight-top highlight-bottom");
//                            		//去掉多余边框
//                            		var id=$(this).attr("id");
//                            		var col=id.split("-")[0];
//                            		var row=id.split("-")[1];
//                            		//上
//                            		if($("#"+col+"-"+(row-1)).is(".highlight")){
//                            			$(this).removeClass("highlight-top");
//                            			$("#"+col+"-"+(row-1)).removeClass("highlight-bottom");
//                            		}
//                            		//下
//                            		if($("#"+col+"-"+(row+1)).is(".highlight")){
//                            			$(this).removeClass("highlight-bottom");
//                            			$("#"+col+"-"+(row+1)).removeClass("highlight-top");
//                            		}
//                            		//左
//                            		if($("#"+(col-1)+"-"+row).is(".highlight")){
//                            			$(this).removeClass("highlight-left");
//                            			$("#"+(col-1)+"-"+row).removeClass("highlight-right");
//                            		}
//                            		//右
//                        			if($("#"+(col+1)+"-"+row).is(".highlight")){
//                        				$(this).removeClass("highlight-right");
//                        				$("#"+(col+1)+"-"+row).removeClass("highlight-left");
//                        			}
                            	});
            ...
            $(document).on('mouseup', function (e) {
                 ...
                 // Table found
                 if ($(table).is('.jexcel')) {
                 	$(table).find("tbody td").off('mouseover');
                 }
            });
...
//        	//corner = $(cells).eq($(cells).length -1);
//        	alert($(corner).offset().top);
